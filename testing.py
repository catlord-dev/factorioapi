...
from FactorioAPI.Data.Files.achievements import readArrayWithContext, readShortArray, readHeader, readContent

f = open("./testing/achievements-modded.dat", "rb")
...
with open("./testing/achievements-modded.json", "w") as outfile:
